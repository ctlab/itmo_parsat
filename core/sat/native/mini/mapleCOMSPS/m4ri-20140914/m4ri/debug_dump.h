...
extern void m4ri_dd_rci_array(
    char const* function, char const* file, int line, rci_t* rciptr, int len);
extern void m4ri_dd_rawrow(
    char const* function, char const* file, int line, word const* rowptr, wi_t wide);
extern void m4ri_dd_row(
    char const* function, char const* file, int line, struct mzd_t const* M, rci_t row);
...
#define __M4RI_DD_RCI_ARRAY(rciptr, len) \
  m4ri_dd_rci_array(__FUNCTION__, __FILE__, __LINE__, rciptr, len)
#define __M4RI_DD_RAWROW(rowptr, wide) \
  m4ri_dd_rawrow(__FUNCTION__, __FILE__, __LINE__, rowptr, wide)
