...
TEST(propagation, correctness_no_dummy) {
  ...
  core::sat::Problem problem(IPS_PROJECT_ROOT "/resources/cnf/common/unsat_pancake_vs_selection_7_4-@2.cnf");
...
TEST(propagation, correctness_subtree) {
  util::random::Generator gen(239);
  std::filesystem::path cnf_path(IPS_PROJECT_ROOT "/resources/cnf/common/unsat_pancake_vs_selection_7_4-@2.cnf");
